                    ...
                    $.each(data,function (num,data) {
                        $("#order").append(
                            "<tr><td>"+data.animalId+"</td><td>"
                            		...
                            		+data.animalPrice+'</td><td><input type="button" value="修改">'+
...
<%@include file="title2.jsp" %>
	<div>
<p style="font-size:20px;text-align:center" id="title">欢迎进入商品管理模块</p>
<br/>
</div>
<!-- 增删改查 -->
    <div class="page">
